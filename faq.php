...
else
{
  ...
  $zapytanie= "SELECT id, tytul, podtytul, tresc FROM content WHERE id = '4'";
...
<div class="row g-5" style="margin-top: 20px;">
    ...
    <nav class="blog-pagination" aria-label="Pagination">
        <a class="btn btn-outline-primary rounded-pill" href="formularz.php">Twoje pytanie nie znajduje się na liście? Kliknij tutaj!</a>
