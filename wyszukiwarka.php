...
<html lang="en">
<head>
    <title>Reklama w wyszukiwarce</title>
    <meta charset="UTF-8">
...
else
{
  ...
  $zapytanie= "SELECT id, tytul, podtytul, tresc FROM content WHERE id = '1'";
...
<div class="row g-5" style="margin-top: 20px;">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        ...
        <p class="blog-post-meta">June 12, 2021 by Jakub</p>
    ...
    <nav class="blog-pagination" aria-label="Pagination">
        <a class="btn btn-outline-primary rounded-pill" href="formularz.php">Masz pytania do naszej oferty? Kliknij tutaj!</a>
